...
accelerate launch --config_file "$workspace_dir/axolotl/accelerate/multi_gpu_config.yaml" -m axolotl.cli.train ./config_run/phi3_pruned_extra_pretrain_22_29_residual_8_a100_4.yaml