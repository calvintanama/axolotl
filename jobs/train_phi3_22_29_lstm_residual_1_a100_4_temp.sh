...
#SBATCH --job-name=lstm_residual-1-normal-ctanama
...
accelerate launch --config_file "$workspace_dir/axolotl/accelerate/multi_gpu_config.yaml" -m axolotl.cli.train ./config_run/phi3_pruned_extra_pretrain_22_29_lstm_residual_1_a100_4.yaml