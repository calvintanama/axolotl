...
#SBATCH --job-name=bottleneck-residual-hadamard-8-normal-ctanama
...
accelerate launch --config_file "$workspace_dir/axolotl_old/axolotl/accelerate/multi_gpu_config.yaml" -m axolotl.cli.train ./config_run/phi3_pruned_extra_pretrain_22_29_bottleneck_residual_hadamard_8_a100_4_local.yaml