...
#SBATCH --job-name=residual-16-normal-ctanama
...
accelerate launch --config_file "$workspace_dir/axolotl_old/axolotl/accelerate/multi_gpu_config.yaml" -m axolotl.cli.train ./config_run/phi3_pruned_extra_pretrain_1_16_residual_16_a100_4_local.yaml